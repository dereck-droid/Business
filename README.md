...
│
├── /opportunities/ (Active Pipeline)
│   ├── prospect-tracker.md (High-level table view)
│   └── pipeline-value.md (Financial projections)
│
├── /company/ (Who We Are)
│   ├── identity.md (Business overview)
│   ├── personality-profile.md (ENFP + Working Genius + DISC)
│   └── background.md (Dereck's professional journey)
│
├── /services/ (What We Offer)
│   ├── offerings.md (Services and capabilities)
│   ├── pricing.md (How we charge)
│   └── delivery.md (How we work)
│
├── /detailed-context/ (Deep Dives)
│   ├── /prospects/ (Individual prospect files)
│   │   ├── retarget-iq-lead-supercharger.md (Partnership offer - GAME CHANGER)
│   │   ├── ben-equitypro.md (Warm lead, senior team meeting)
│   │   ├── kin-upgrade.md ($3,564 opportunity)
│   │   ├── l2t-media.md (Automotive partnership)
│   │   ├── 365-digital.md (Enterprise automation)
│   │   ├── dc-pipeline.md (Friend, warm lead)
│   │   ├── pool-builders.md (Cold campaign)
│   │   └── gfcu-potential-recovery.md (Passive opportunity)
│   │
│   ├── /projects/ (Product & Project Deep Dives)
│   │   ├── prayer-board-app.md (85% complete, $60-300K potential)
│   │   ├── ad-checker-solution.md (FB complete, unique market)
│   │   ├── elimination-diet-app.md ($5M opportunity, voice AI)
│   │   ├── music-school-software.md (Ken's $23K project)
│   │   └── gfcu-potential-recovery.md
│   │
│   └── /completed/ (Historical Reference)
│       └── previous-clients.md
│
└── /decision-framework/ (How to Prioritize)
    ├── priority-scoring-system.md (Scoring criteria)
    └── zone-based-weighting.md (Red/Yellow/Green zones)
```
...
- ✅ Wonder (ideation, seeing opportunities)
- ✅ Discernment (gut feel on what will work)
- ✅ Relationship building (warm leads convert 100%)
- ✅ Strategic thinking and vision

**Support His Weaknesses:**
- ⚠️ Tenacity (execution, follow-through)
- ⚠️ Focus (too many ideas competing)
- ⚠️ Administrative details
- ⚠️ Completion (multiple 85-90% done projects)

**Provide:**
- ✅ Structure and accountability (this repository!)
- ✅ Forcing functions and deadlines
- ✅ Execution support (Claude Code handles implementation)
- ✅ Priority guidance (framework over emotion)
...
### For Dereck
- ⚠️ Check FOCUS.md EVERY morning (don't rely on memory)
- ⚠️ Update prospect statuses when they change (accountability)
- ⚠️ Trust the framework when overwhelmed (it's designed for ENFP brain)
- ⚠️ ONE priority at a time (Wonder will generate infinite ideas - that's okay, capture and defer)
- ✅ This repository IS the Tenacity system you need

### For AI Agents
- ⚠️ Read FOCUS.md first, always
- ⚠️ Respect financial zone (Red = survival, no long-term builds)
- ⚠️ Dereck's Discernment is rarely wrong (trust his gut)
- ⚠️ Keep him in Genius zone (Wonder/Discernment), handle Tenacity
- ✅ Provide structure without rigidity (ENFP needs flexibility within framework)
